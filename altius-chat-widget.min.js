...
!(function () {
  ...
  if (!window.AltiusChatWidget) {
    ...
    const generateStyles = () => `
      ...
      .altius-chat-bubble:hover::before {
        opacity: 1;
      }
      ...
      .altius-chat-bubble:active {
        transform: scale(0.95);
      }
      
      .altius-chat-bubble.open {
        transform: scale(1.1);
        box-shadow: 0 6px 20px ${theme.colors.shadow.medium};
      }
      
      .altius-chat-bubble.open .altius-chat-icon {
        opacity: 0;
        transform: scale(0.8) rotate(-90deg);
      }
      
      .altius-chat-bubble.open .altius-close-icon {
        opacity: 1;
      ...
      .altius-chat-bubble .altius-close-icon {
        width: 24px;
        height: 24px;
        fill: ${theme.colors.text.primary};
        transition: ${theme.transitions.bounce};
      ...
      .altius-chat-popup {
        ...
        bottom: 80px;
        right: 0;
        width: ${theme.layout.popup.width};
        height: ${theme.layout.popup.height};
      ...
      .altius-chat-popup.show .altius-chat-header::before {
        left: 100%;
      }
      ...
      .altius-chat-logo {
        ...
        transition: ${theme.transitions.fast};
        animation: altius-logo-pulse 2s ease-in-out infinite;
        box-shadow: 0 2px 8px rgba(16,185,129,0.12);
      }
      
      @keyframes altius-logo-pulse {
        0%, 100% {
          transform: scale(1);
      ...
      .altius-chat-message.user {
        background: #ffe5e5; /* warna soft */
        color: #b91c1c;      /* warna teks lebih gelap */
        align-self: flex-end;
      ...
      .altius-chat-input-area {
        ...
        gap: ${theme.spacing.md};
        align-items: center;
        animation: altius-input-slide 0.5s ease-out 0.3s both;
      }
      
      @keyframes altius-input-slide {
        from {
          opacity: 0;
      ...
      .altius-chat-send:disabled::before {
        display: none;
      }
      ...
      .altius-chat-send:hover .altius-chat-send-icon {
      ...
      @media (max-width: 480px) {
        .altius-chat-popup {
          width: ${theme.layout.popup.mobile.width};
          height: ${theme.layout.popup.mobile.height};
          bottom: 80px;
          right: ${theme.spacing.xl};
    ...
    function i() {
      ...
      return (
        (e.className = "altius-chat-widget"),
        (e.innerHTML = `
            ...
            <div class="altius-chat-popup" id="altius-chat-popup">
                ...
                <div class="altius-chat-input-area">
                    ...
                    <button class="altius-chat-send" id="altius-chat-send">
                        <svg class="altius-chat-send-icon" viewBox="0 0 24 24" width="32" height="32">
    ...
    function a() {
      ...
      let chatHistory = [
        {
          role: "assistant",
          content: "Halo! Saya Altius Assistant. Ada yang bisa saya bantu?",
        },
      ];
      ...
      function r(e, t = !1, customTime = null) {
        ...
        n.className = `altius-chat-message ${t ? "user" : "bot"}`;
        ...
        header.className = "altius-chat-message-header";

        const agentName = document.createElement("span");
        agentName.textContent = t ? "Anda" : "Altius Assistant";
        ...
        content.className = "altius-chat-message-content";
      ...
      function u() {
        const e = document.createElement("div");
        (e.className = "altius-typing-indicator"),
          (e.id = "altius-typing"),
          (e.innerHTML =
      ...
      // Menampilkan pesan selamat datang awal
      r(
