!(function () {
  ...
  if (!window.AltiusChatWidget) {
    ...
    let chatToggle, chatContainer, chatMessages, chatInput, chatSend;
                ...
                <div id="chat-messages" class="chat-messages">
                    <div class="message bot-message">
                        <div class="message-content">
                            <div class="message-text">Halo! Saya Assistant Anda. Ada yang bisa saya bantu?</div>
    ...
    function setupEventListeners() {
      ...
      document.addEventListener("click", (event) => {
        if (
          isChatOpen &&
          !document.getElementById(CONFIG.WIDGET_ID).contains(event.target)
        ) {
          closeChat();
        }
      });
    ...
    // API communication
    async function sendChatMessage(prompt, isInitial = false) {
      try {
        const requestBody = {
          session_id: currentSessionId || "",
          prompt: prompt,
          user_profile:
            window.personal_data || "corp_id = 000 , NIP = 000210058",
        };
    ...
    async function initializeSession() {
      try {
        ...
        // Create initial session by sending a welcome message
        const response = await sendChatMessage("Halo", true);

        if (response && response.session_id) {
          currentSessionId = response.session_id;
          console.log("Session initialized:", currentSessionId);

          // Update the initial bot message with the actual response
          ...
          if (initialMessage) {
            initialMessage.textContent =
              response.response ||
              "Halo! Saya Altius Assistant. Ada yang bisa saya bantu?";
          }
        } else {
    ...
    function generateStyles() {
      return `
            ...
            .chat-toggle {
                ...
                cursor: pointer;
                box-shadow: 0 4px 20px rgba(127, 216, 194, 0.3);
            ...
            .chat-toggle:hover {
                transform: scale(1.1);
                box-shadow: 0 6px 25px rgba(127, 216, 194, 0.4);
            }
          ...
          height: ${CONFIG.CONTAINER_HEIGHT};
                background: #f8fafc;
                border-radius: 12px;
                box-shadow: 0 10px 40px rgba(127, 216, 194, 0.15);
                display: none;
            ...
            .chat-close:hover {
                background: rgba(79, 140, 165, 0.1);
            }
            ...
            .message-text code {
                background: rgba(127, 216, 194, 0.1);
                padding: 2px 4px;
                border-radius: 3px;
            ...
            .bot-message .message-text {
                ...
                box-shadow: 0 1px 2px rgba(127, 216, 194, 0.1);
            }
