  ...
  if (!window.AltiusChatWidget) {
    ...
    const generateStyles = () => `
      ...
      .altius-chat-header {
        ...
        box-shadow: 0 4px 18px 0 rgba(239,68,68,0.10);
        transition: background 0.4s, box-shadow 0.3s;
      }
      .altius-chat-header:hover {
      ...
      .altius-chat-logo {
        ...
        align-items: center;
        justify-content: center;
        box-shadow: 0 2px 8px 0 #ef444488, 0 0 0 2px #fff;
        padding: 2px;
        overflow: visible;
        margin-right: 0px;
      ...
      .altius-chat-send:disabled .altius-chat-send-icon {
        fill: #ccc;
      }
            ...
            <div class="altius-chat-popup" id="altius-chat-popup">
                <div class="altius-chat-header">
                    ...
                    <div style="display:flex;flex-direction:column;align-items:flex-start;">
                      ...
                      <div class="altius-chat-status"><span class="altius-chat-status-dot"></span>Online</div>
                    </div>
                </div>
                ...
                <div class="altius-chat-input-area">
                    ...
                    <button class="altius-chat-send" id="altius-chat-send">
                        <svg class="altius-chat-send-icon" viewBox="0 0 24 24" width="6" height="6">
